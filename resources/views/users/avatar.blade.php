...
@section('scripts')
    ...
    <script src="{{ url('/js/dropzone-config-avatar.js') }}"></script>
@endsection
...
<div class="row profile">
        ...
        <div class="col-md-7">
                    <div class="card">
                        ...
                        <br>
                            {!! Form::open(['method' => 'POST', 'url' => route('avatar'), 'files' => true, 'class' => 'dropzone', 'id' => 'my-dropzone']) !!}

                            <div class="dz-message">
                                <div class="col-xs-8">
                                    <div class="message">
                                        <p>{!! trans('app.upload2') !!}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <br>
                            <p class="alert alert-success" id="notice">Upload avatar successfully</p>                            
                        </div>
                    </div>
                </div>
