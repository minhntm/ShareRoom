        ...
        <div class="container">
            {!! Form::open(['method' => 'POST', 'url' => route('rooms.store')]) !!}
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            {!! Form::checkbox('is_tv') !!} {{ trans('app.tv') }}
                        </div>
                        <div class="form-group">
                            {!! Form::checkbox('is_kitchen') !!} {{ trans('app.kitchen') }}
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            {!! Form::checkbox('is_internet') !!} {{ trans('app.internet') }}
                        </div>
                        <div class="form-group">
                            {!! Form::checkbox('is_heating') !!} {{ trans('app.heating') }}
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            {!! Form::checkbox('is_air') !!} {{ trans('app.air') }}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col form-group">
                        {!! Form::checkbox('active') !!} {{ trans('app.active') }}
                    </div>
                </div>
